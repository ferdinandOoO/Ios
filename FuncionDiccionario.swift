...
//llave String int promedio de los examenes, porcentajes de las practicas participaciones calificaciones


var misCalificaciones: [String:Double] = [
    "porcentajeExamenes": 0,
    "porcentajePracticas": 0,
    "porcentajeParticipaciones": 0,
    "calificacionFinal": 0
]

//Se declara la variable con valor de la llave y la referencia
//var califFer: [String:Double] = [String:Double]()

//califFer.updateValue(porcentajeExamenes, forkey: "porcentajeExamenes")
//califFER.updateValue(porcentajePracticas, forkey: "porcentajePracticas")
//califFER.updateValue(porcentajeParticipaciones, forkey: "porcentajeParicipaciones")
//califFER.updateValue(calificacionFinal, forkey: "calificacionFinal")